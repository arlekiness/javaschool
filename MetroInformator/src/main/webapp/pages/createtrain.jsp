    ...
    <div class="cd-user-modal">
        <div class="cd-user-modal-container">
            ...
            <div id="cd-signup" class="is-selected">
                <form class="cd-form half-form" action="/createtrain" method="post">
                    <p class="fieldset">
                        <label for="signup-firstname">Train №</label>
                        <input autofocus class="full-width has-padding has-border" id="signup-firstname" name="trainname" type="text" placeholder="Train №" required>
                    </p>

                    <p class="fieldset">
                        <label for="signup-lastname">Start station</label>
                        <input class="full-width has-padding has-border" id="signup-lastname" type="text" name="startstation" placeholder="Start station" value='' autocomplete='off' list='stations_list'>
                    ...
                    <p class="fieldset">
                        ...
                        <input class="full-width has-padding-icon has-border" id="date" type="text" name="date"  placeholder="Start date" onClick="xCal(this)" onKeyUp="xCal()" required>
                        <a href="#0" class="date-icon"><i class="icon-calendar"></i></a>
                    </p>

                    <p class="fieldset">
                        <input class="full-width has-padding has-border" id="signup-lastname" name="time" type="time" placeholder="Arrival time" style="padding-right: 90px;" required>
