            ...
            <div id="cd-signup" class="is-selected">
                <form class="cd-form half-form" action="/createtrain" method="post">
                    <p class="fieldset">
                        ...
                        <input autofocus class="full-width has-padding has-border" id="signup-firstname"
                               name="trainname" type="text" placeholder="Train №" required>
                    </p>

                    <p class="fieldset">
                        <label for="signup-lastname">Start station</label>
                        <input class="full-width has-padding has-border" id="signup-lastname" type="text"
                               name="startstation" placeholder="Start station" value='' autocomplete='off'
                               list='stations_list'>
