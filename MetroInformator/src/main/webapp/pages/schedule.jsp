...
<head>
    <meta charset="utf-8">
    <title>meTro-Systems - Shedule</title>
...
<div id="site-content" class="tickets-page">
    ...
    <div class="wrapper-tickets">
        <p class="hero-text text-center">Check train schedule</p>

        <div id='content'>
            <div id='input_box'>
                <form class="cd-form cd-form1" action="/schedule" method="POST">

                    <input class="full-width has-padding has-border" type='text' placeholder='Station' name='start'
                           value='' autocomplete='off' list='stations_list' required id='station1'>
                ...
                <c:if test="${not empty model.parseException}">
                    <script>
                        swal({
                            title: 'SOME PROBLEMS',
                            text: 'You use form instead of calendar? It\'s your fault',
                            type: 'error'
                        });
                    </script>
                </c:if>
