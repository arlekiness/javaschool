                ...
                <ul class="slides">
                    <li>
                        <div class="flex-caption">
                            ...
                            <form class="cd-form" action="/login" method="POST" name="forma_1">
                                ...
                                <p class="fieldset">
                                    ...
                                    <input class="full-width has-padding has-border" id="signin-password" type="password" maxlength="100" size="11" name="password" value="" placeholder="Password">
                            ...
                            <div class="register-signin-home main-nav1" style="margin: 0 0 0 138px;">
                                <ul>
                                    <li><span><a href="/registration" class="cd-signup" style="background-color: #fff; color: #000; border: none; text-decoration: underline;">REGISTER</a></span></li>
                                </ul>
                            </div>
