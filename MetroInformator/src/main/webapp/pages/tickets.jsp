        ...
        <div id='content'>
            <div id='input_box'>
                <form action="/tickets" method="POST" class="cd-form cd-form1">
                    <input class="full-width has-padding has-border" type='text' placeholder='Start Station'
                           name='begin' value='' autocomplete='off' list='stations_list' required id='station1'>

                    <input class="full-width has-padding has-border" type='text' placeholder='End Station' name='end'
                           value='' autocomplete='off' list='stations_list' required id='station2'>
                    ...
                    <p class="fieldset" style="display: inline-block; width: 20%">
                        ...
                        <input class="full-width has-padding-icon has-border" name="date" id="date" type="text"
                               placeholder="Date" onClick="xCal(this)" onKeyUp="xCal()" required>
